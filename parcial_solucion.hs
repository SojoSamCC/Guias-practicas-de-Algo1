...
cantidadRepetidos producto [[x]] | producto==[x] = 1   
                                 | otherwise = 0
cantidadRepetidos producto ((x:xs)) | producto==x =1+cantidadRepetidos producto xs
                                    | otherwise = cantidadRepetidos producto xs
